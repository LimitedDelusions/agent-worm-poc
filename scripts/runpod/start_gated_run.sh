#!/usr/bin/env bash
set -Eeuo pipefail
ROOT="${AGENT_WORM_PROJECT_ROOT:-/workspace/agent_worm_poc_v0.8.5}"
...
Path(path).write_text(json.dumps({
 ...
 'project_root':os.environ.get('AGENT_WORM_PROJECT_ROOT','/workspace/agent_worm_poc_v0.8.5')},indent=2)+'\n')
PYCODE
